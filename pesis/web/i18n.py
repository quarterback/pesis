...
S: dict[str, dict[str, str]] = {
    ...
    "stat.adv1_pct": {"fi": "1P ADV%", "en": "1B ADV%"},
    "stat.adv2_pct": {"fi": "2P ADV%", "en": "2B ADV%"},
    "stat.adv3_pct": {"fi": "3P ADV%", "en": "3B ADV%"},
    "stat.adv_home_pct": {"fi": "Koti ADV%", "en": "Home ADV%"},
    "stat.adv1_plus": {"fi": "1P ADV+", "en": "1B ADV+"},
    "stat.adv2_plus": {"fi": "2P ADV+", "en": "2B ADV+"},
    "stat.adv3_plus": {"fi": "3P ADV+", "en": "3B ADV+"},
    "stat.adv_home_plus": {"fi": "Koti ADV+", "en": "Home ADV+"},
