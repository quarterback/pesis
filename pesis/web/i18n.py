...
S: dict[str, dict[str, str]] = {
    ...
    "stat.adv1_pct": {"fi": "1 %", "en": "1%"},
    "stat.adv2_pct": {"fi": "2 %", "en": "2%"},
    "stat.adv3_pct": {"fi": "3 %", "en": "3%"},
    "stat.adv_home_pct": {"fi": "K %", "en": "K%"},
    "stat.adv1_plus": {"fi": "1 %+", "en": "1%+"},
    "stat.adv2_plus": {"fi": "2 %+", "en": "2%+"},
    "stat.adv3_plus": {"fi": "3 %+", "en": "3%+"},
    "stat.adv_home_plus": {"fi": "K %+", "en": "K%+"},
    ...
    "stat.kl_base0": {"fi": "1 % (1→2)", "en": "1% (1st→2nd)"},
    "stat.kl_base1": {"fi": "2 % (2→3)", "en": "2% (2nd→3rd)"},
    "stat.kl_base2": {"fi": "3 % (3→koti)", "en": "3% (3rd→home)"},
    "stat.kl_base3": {"fi": "K % (kotiutus)", "en": "K% (scoring)"},
